...
export class Challenge extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = 'kubernetes:acme.cert-manager.io/v1alpha3:Challenge';
  ...
  public readonly apiVersion!: pulumi.Output<'acme.cert-manager.io/v1alpha3' | undefined>;
  public readonly kind!: pulumi.Output<'Challenge' | undefined>;
  public readonly metadata!: pulumi.Output<ObjectMeta>;
  public readonly spec!: pulumi.Output<outputs.acme.v1alpha3.ChallengeSpec | undefined>;
  public readonly status!: pulumi.Output<outputs.acme.v1alpha3.ChallengeStatus | undefined>;
...
export type ChallengeArgs = {
  ...
  readonly spec?: pulumi.Input<inputs.acme.v1alpha3.ChallengeSpecArgs>;
  readonly status?: pulumi.Input<inputs.acme.v1alpha3.ChallengeStatusArgs>;
};
