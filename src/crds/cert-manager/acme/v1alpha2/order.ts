...
export class Order extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = 'kubernetes:acme.cert-manager.io/v1alpha2:Order';
  ...
  public readonly spec!: pulumi.Output<outputs.acme.v1alpha2.OrderSpec | undefined>;
  public readonly status!: pulumi.Output<outputs.acme.v1alpha2.OrderStatus | undefined>;
