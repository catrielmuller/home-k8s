...
export class CertificateRequest extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = 'kubernetes:cert-manager.io/v1alpha2:CertificateRequest';
  ...
  public readonly spec!: pulumi.Output<
    outputs.certmanager.v1alpha2.CertificateRequestSpec | undefined
  >;
  /**
   * Status of the CertificateRequest. This is set and managed automatically.
   */
  public readonly status!: pulumi.Output<
    outputs.certmanager.v1alpha2.CertificateRequestStatus | undefined
  >;
...
export type CertificateRequestArgs = {
   ...
   * Desired state of the CertificateRequest resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1alpha2.CertificateRequestSpecArgs>;
  /**
   * Status of the CertificateRequest. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1alpha2.CertificateRequestStatusArgs>;
};
