...
export class ClusterIssuer extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = 'kubernetes:cert-manager.io/v1alpha2:ClusterIssuer';
   ...
   */
  public readonly spec!: pulumi.Output<outputs.certmanager.v1alpha2.ClusterIssuerSpec | undefined>;
  /**
   * Status of the ClusterIssuer. This is set and managed automatically.
   */
  public readonly status!: pulumi.Output<
    outputs.certmanager.v1alpha2.ClusterIssuerStatus | undefined
  >;
...
export type ClusterIssuerArgs = {
   ...
   * Desired state of the ClusterIssuer resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1alpha2.ClusterIssuerSpecArgs>;
  /**
   * Status of the ClusterIssuer. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1alpha2.ClusterIssuerStatusArgs>;
};
