...
export class Issuer extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = 'kubernetes:cert-manager.io/v1beta1:Issuer';
   ...
   */
  public readonly spec!: pulumi.Output<outputs.certmanager.v1beta1.IssuerSpec>;
  /**
   * Status of the Issuer. This is set and managed automatically.
   */
  public readonly status!: pulumi.Output<outputs.certmanager.v1beta1.IssuerStatus | undefined>;
...
export type IssuerArgs = {
   ...
   * Desired state of the Issuer resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1beta1.IssuerSpecArgs>;
  /**
   * Status of the Issuer. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1beta1.IssuerStatusArgs>;
};
