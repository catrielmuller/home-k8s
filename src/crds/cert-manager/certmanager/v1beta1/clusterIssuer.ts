...
export class ClusterIssuer extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = 'kubernetes:cert-manager.io/v1beta1:ClusterIssuer';
   ...
   */
  public readonly spec!: pulumi.Output<outputs.certmanager.v1beta1.ClusterIssuerSpec>;
  /**
   * Status of the ClusterIssuer. This is set and managed automatically.
   */
  public readonly status!: pulumi.Output<
    outputs.certmanager.v1beta1.ClusterIssuerStatus | undefined
  >;
...
export type ClusterIssuerArgs = {
   ...
   * Desired state of the ClusterIssuer resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1beta1.ClusterIssuerSpecArgs>;
  /**
   * Status of the ClusterIssuer. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1beta1.ClusterIssuerStatusArgs>;
};
