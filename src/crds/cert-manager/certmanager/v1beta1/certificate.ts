...
export type CertificateArgs = {
   ...
   * Desired state of the Certificate resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1beta1.CertificateSpecArgs>;
  /**
   * Status of the Certificate. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1beta1.CertificateStatusArgs>;
};
