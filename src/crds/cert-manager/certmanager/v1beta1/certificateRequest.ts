...
export class CertificateRequest extends pulumi.CustomResource {
  ...
  public readonly status!: pulumi.Output<
    outputs.certmanager.v1beta1.CertificateRequestStatus | undefined
  >;
...
export type CertificateRequestArgs = {
   ...
   * Desired state of the CertificateRequest resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1beta1.CertificateRequestSpecArgs>;
  /**
   * Status of the CertificateRequest. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1beta1.CertificateRequestStatusArgs>;
};
