...
export class Certificate extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = 'kubernetes:cert-manager.io/v1alpha3:Certificate';
   ...
   */
  public readonly spec!: pulumi.Output<outputs.certmanager.v1alpha3.CertificateSpec | undefined>;
  /**
   * Status of the Certificate. This is set and managed automatically.
   */
  public readonly status!: pulumi.Output<
    outputs.certmanager.v1alpha3.CertificateStatus | undefined
  >;
...
export type CertificateArgs = {
   ...
   * Desired state of the Certificate resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1alpha3.CertificateSpecArgs>;
  /**
   * Status of the Certificate. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1alpha3.CertificateStatusArgs>;
};
